...
import { createPlaylist, addTrackToPlaylist as apiAddTrackToPlaylist } from "../../services/playlistService";
import usePlaylistStore from "../../store/usePlaylistStore";

export default function AddToPlaylistModal({ track, isOpen, onClose }) {
    const { userPlaylists, addPlaylist, addTrackToPlaylist } =
        usePlaylistStore();
    ...
    const handleCreateAndAdd = async () => {
        ...
        try {
            ...
            await apiAddTrackToPlaylist(newPlaylist.id, track.id);
